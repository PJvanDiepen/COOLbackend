...
import { o_o_o, init, competitieTitel, laatsteUitslagenRonde } from "./o_o_o.js"
...
async function uitslagenSpeler(kop, lijst) {
    const t = (await ranglijst(laatsteUitslagenRonde(), [o_o_o.speler]))[0];
    ...
    if (t.intern() && t.eigenWaardeCijfer()) {
        const datumKolom = "01-09-2024"; // TODO iets met datumLeesbaar;
        lijst.append(html.rij("", datumKolom, `waardecijfer: ${t.eigenWaardeCijfer()}`, "", "", "", totaal, totaal, t.rating()));
    }
