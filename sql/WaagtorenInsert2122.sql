...
select * from ronde
where seizoen = '2122' and teamCode = 'n4' and rondeNummer = 6; -- Waagtoren n4 - Koedijk

select naam, u.* from uitslag u join persoon p on p.knsbNummer = u.knsbNummer
where seizoen = '2122' and ((teamCode = 'int' and rondeNummer = 16) or (teamCode = 'n4' and rondeNummer = 6))
and u.knsbNummer in (8750093, 6212404, 8485059, 7518203, 7321534, 8073978) order by naam;

update uitslag set partij = 't' -- thuis
where seizoen = '2122' and teamCode = 'int' and rondeNummer = 16
and knsbNummer in (8750093, 6212404, 8485059, 7518203, 7321534, 8073978); 
  
delete from uitslag
where seizoen = '2122' and teamCode = 'n4' and rondeNummer = 6
and knsbNummer in (8750093, 6212404, 8485059, 7518203, 7321534, 8073978); 
...
('2122', 'n4', 6, 0, 8750093, 't', '', 0, '', '2022-03-15', 'int'), -- Martin Rep
('2122', 'n4', 6, 0, 6212404, 't', '', 0, '', '2022-03-15', 'int'), -- PvD
('2122', 'n4', 6, 0, 8485059, 't', '', 0, '', '2022-03-15', 'int'), -- Peter Duijs
('2122', 'n4', 6, 0, 7518203, 't', '', 0, '', '2022-03-15', 'int'), -- Theo de Bruijn
('2122', 'n4', 6, 0, 7321534, 't', '', 0, '', '2022-03-15', 'int'), -- Ronald Kamps
('2122', 'n4', 6, 0, 8073978, 't', '', 0, '', '2022-03-15', 'int'); -- Gerrit Peereboom
...
('2122', 'n3', '2', 'u', 'Bergen N', 'Bergen', '2021-12-09'),
('2122', 'n3', '3', 't', 'Aartswoud N2', 'Alkmaar', '2022-02-15'),
('2122', 'n3', '4', 'u', 'Oppositie N', 'Heiloo', '2022-03-15'),
('2122', 'n3', '5', 'u', 'Noordkopcombinatie MSC N2', 'Den Helder', '2022-04-05'),
...
use waagtoren; -- PvD
select * from uitslag where seizoen = '2122' and teamCode = 'int' and rondeNummer = 16;
delete from uitslag where seizoen = '2122' and teamCode = 'int' and rondeNummer = 16;

insert into uitslag (seizoen, teamCode, rondeNummer, bordNummer, knsbNummer, partij, witZwart, tegenstanderNummer, resultaat, datum, anderTeam) values
('2122', 'int', 16, 0, 6212404, 'a', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7321534, 'a', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7518203, 'a', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8073978, 'a', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8485059, 'a', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8750093, 'a', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 101, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 103, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6192098, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6214153, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6572511, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6951362, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7099950, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7269834, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7502143, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7529522, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7535396, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7544438, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7691728, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7731812, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7824674, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8224502, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8372881, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8400183, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8472530, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8587337, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8611922, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8931098, 'm', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 102, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 105, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 111, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 113, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 114, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 115, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 116, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 117, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 118, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 119, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 120, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6187885, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6225934, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6335670, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6483455, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 6930957, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7063881, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7079743, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7099620, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7129991, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7210137, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7282033, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7292043, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7399469, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7419621, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7428960, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7468362, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7468417, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7504310, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7509920, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7535385, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7561653, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7582102, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7584566, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7613166, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7640798, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7649213, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7657342, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7665834, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7699010, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7707084, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7707832, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7758014, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7809285, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7828183, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7879520, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7904589, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 7970094, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8096242, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8112654, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8180810, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8193548, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8276752, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8285574, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8305473, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8335415, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8484443, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8552038, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8617367, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8865549, 'n', '', 0, '', '2022-03-22', 'int'),
('2122', 'int', 16, 0, 8956805, 'n', '', 0, '', '2022-03-22', 'int');
