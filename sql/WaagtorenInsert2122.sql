...
insert into uitslag (seizoen, teamCode, rondeNummer, bordNummer, knsbNummer, partij, witZwart, tegenstanderNummer, resultaat, datum, anderTeam) values
('2122', 'n3', 4, 0, 7504310, 't', '', 0, '', '2022-03-15', 'int'),
('2122', 'n3', 4, 0, 8372881, 't', '', 0, '', '2022-03-15', 'int'),
('2122', 'n3', 4, 0, 7210137, 't', '', 0, '', '2022-03-15', 'int'),
('2122', 'n3', 4, 0, 7731812, 't', '', 0, '', '2022-03-15', 'int'),
('2122', 'n3', 4, 0, 6214153, 't', '', 0, '', '2022-03-15', 'int'),
('2122', 'n3', 4, 0, 7649213, 't', '', 0, '', '2022-03-15', 'int'),
('2122', 'n3', 4, 0, 8276752, 't', '', 0, '', '2022-03-15', 'int'),
('2122', 'n3', 4, 0, 7399469, 't', '', 0, '', '2022-03-15', 'int');
...
select * from uitslag where datum < '2022-03-12' and partij in ('m', 'n', 'u', 't') order by datum;

delete from uitslag where seizoen = '2122' and datum < '2022-03-12' and partij in ('m', 'n', 'u', 't');
