...
select * from speler where seizoen = '2122' and knsbNummer = 114;
...
select naam, u.* from uitslag u join persoon p on u.knsbNummer = p.knsbNummer where seizoen = '2122' and teamCode = 'int' and datum = '2021-10-26' and u.knsbNummer in 
(6214153, 7282033, 7210137, 8276752, 7649213, 8750093, 6212404, 7321534);

update uitslag set partij = 'x' where seizoen = '2122' and teamCode = 'int' and datum = '2021-10-26' and knsbNummer in 
(6214153, 7282033, 7210137, 8276752, 7649213, 8750093, 6212404, 7321534);
...
('2122', 'n3', '1', 't', 'Caïssa-Eenhoorn N2', 'Alkmaar', '2021-11-16'),
('2122', 'n3', '2', 'u', 'Bergen N', '', '2021-12-09'),
('2122', 'n3', '3', 't', 'Aartswoud N2', 'Alkmaar', '2022-02-15'),
('2122', 'n3', '4', 'u', 'Oppositie N', '', '2022-03-15'),
('2122', 'n3', '5', 'u', 'Noordkopcombinatie MSC N2', '', '2022-04-05'),
('2122', 'n3', '6', 't', 'Schaakmat N1', 'Alkmaar', '2022-04-26'),
('2122', 'n4', '1', 'u', 'Opening 64 N2', '', '2021-11-19'),
('2122', 'n4', '2', 't', 'Heerhugowaard N1', 'Alkmaar', '2021-12-14'),
('2122', 'n4', '3', 'u', 'Purmerend N4', '', '2022-01-13'),
('2122', 'n4', '4', 't', 'Schaakmat N1', 'Alkmaar', '2022-02-01'),
('2122', 'n4', '5', 'u', 'Aris de Heer N', '', '2022-02-28'),
('2122', 'n4', '6', 't', 'Koedijk N', 'Alkmaar', '2022-03-22'),
('2122', 'n4', '7', 't', 'Castricum Bakkum Combinatie N2', 'Alkmaar', '2022-04-12');
...
select * from uitslag where seizoen = '2122' and teamCode = 'int' and rondeNummer in (7, 8);
delete from uitslag where seizoen = '2122' and teamCode = 'int' and rondeNummer in (7, 8);
...
('2122', 'int', 8, 0, 7399469, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7535385, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7529522, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7518203, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8112654, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7502143, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8224502, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7419621, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8096242, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7321534, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7282033, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7269834, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7535396, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7544438, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7582102, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7665834, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7691728, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7699010, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7824674, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7707832, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7731812, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7758014, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7809285, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8372881, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6187885, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6192098, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6212404, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6214153, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6225934, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8587337, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6572511, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 114, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6951362, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 103, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8400183, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 101, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7099620, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7099950, 'm', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8865549, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8931098, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8750093, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8617367, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8552038, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7828183, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7879520, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7904589, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8073978, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8611922, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8485059, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8180810, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8193548, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8484443, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8276752, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8472530, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8285574, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 8335415, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7657342, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7707084, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 111, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 113, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 115, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 116, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 117, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6335670, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 105, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6483455, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 6930957, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7063881, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7079743, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7210137, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7129991, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7649213, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7640798, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7584566, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7561653, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7509920, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7504310, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7468417, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7468362, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7428960, 'n', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 8, 0, 7292043, 'n', '', 0, '', '2021-11-02', 'int');

select * from uitslag where seizoen = '2122' and teamCode = 'int' and rondeNummer in (8, 9);
delete from uitslag where seizoen = '2122' and teamCode = 'int' and rondeNummer in (8, 9);
...
delete from uitslag where seizoen = '2122' and teamCode = '4' and rondeNummer = 2;

-- KNSB competitie 6 november 2021 
insert into uitslag (seizoen, teamCode, rondeNummer, bordNummer, knsbNummer, partij, witZwart, tegenstanderNummer, resultaat, datum, anderTeam) values

select * from uitslag where seizoen = '2122' and teamCode = 'int' and rondeNummer in (9, 10);
delete from uitslag where seizoen = '2122' and teamCode = 'int' and rondeNummer in (9, 10);
