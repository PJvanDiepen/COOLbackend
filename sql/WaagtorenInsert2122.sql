...
select * from uitslag where seizoen = '2122' and teamCode = 'n1';
delete from uitslag where seizoen = '2122' and teamCode = 'n1';
...
select * from uitslag where seizoen = '2122' and teamCode = 'n2';
delete from uitslag where seizoen = '2122' and teamCode = 'n2';
...
('2122', 'n2', 4, 0, 6572511, 'n', '', 0, '', '2022-05-27', 'int'),
('2122', 'n2', 4, 0, 6930957, 'n', '', 0, '', '2022-05-27', 'int'),
('2122', 'n2', 4, 0, 7529522, 'n', '', 0, '', '2022-05-27', 'int'),
('2122', 'n2', 4, 0, 7665834, 'n', '', 0, '', '2022-05-27', 'int'),
('2122', 'n2', 4, 0, 7758014, 'n', '', 0, '', '2022-05-27', 'int'),
('2122', 'n2', 4, 0, 8112654, 'n', '', 0, '', '2022-05-27', 'int'),
('2122', 'n2', 4, 0, 8400183, 'n', '', 0, '', '2022-05-27', 'int'),
('2122', 'n2', 4, 0, 8587337, 'n', '', 0, '', '2022-05-27', 'int'),
('2122', 'n2', 4, 0, 8611922, 'n', '', 0, '', '2022-05-27', 'int'),
...
select * from uitslag where seizoen = '2122' and teamCode = 'n3';
delete from uitslag where seizoen = '2122' and teamCode = 'n3';



select * from uitslag where seizoen = '2122' and teamCode = 'n4';
delete from uitslag where seizoen = '2122' and teamCode = 'n4';
...
select * from uitslag where seizoen = '2122' and knsbNummer = 7771665; -- Yvonne Schol

delete from uitslag where seizoen = '2122' and knsbNummer = 7771665;

insert into uitslag (seizoen, teamCode, rondeNummer, bordNummer, knsbNummer, partij, witZwart, tegenstanderNummer, resultaat, datum, anderTeam) values
('2122', 'int', 1, 0, 7771665, 'a', '', 0, '', '2021-09-07', 'int'),
('2122', 'int', 2, 0, 7771665, 'a', '', 0, '', '2021-09-14', 'int'),
('2122', 'int', 3, 0, 7771665, 'a', '', 0, '', '2021-09-21', 'int'),
('2122', 'int', 4, 0, 7771665, 'a', '', 0, '', '2021-09-28', 'int'),
('2122', 'int', 5, 0, 7771665, 'a', '', 0, '', '2021-10-05', 'int'),
('2122', 'int', 6, 0, 7771665, 'a', '', 0, '', '2021-10-12', 'int'),
('2122', 'ira', 1, 0, 7771665, 'a', '', 0, '', '2021-10-19', 'ira'),
('2122', 'ira', 2, 0, 7771665, 'a', '', 0, '', '2021-10-19', 'ira'),
('2122', 'ira', 3, 0, 7771665, 'a', '', 0, '', '2021-10-19', 'ira'),
('2122', 'int', 7, 0, 7771665, 'a', '', 0, '', '2021-10-26', 'int'),
('2122', 'int', 8, 0, 7771665, 'a', '', 0, '', '2021-11-02', 'int'),
('2122', 'int', 9, 0, 7771665, 'a', '', 0, '', '2021-11-09', 'int'),
('2122', 'int', 10, 0, 7771665, 'a', '', 0, '', '2022-02-01', 'int'),
('2122', 'int', 11, 0, 7771665, 'a', '', 0, '', '2022-02-08', 'int'),
('2122', 'int', 12, 0, 7771665, 'a', '', 0, '', '2022-02-15', 'int'),
('2122', 'ira', 6, 0, 7771665, 'a', '', 0, '', '2022-02-22', 'ira'),
('2122', 'ira', 5, 0, 7771665, 'a', '', 0, '', '2022-02-22', 'ira'),
('2122', 'ira', 4, 0, 7771665, 'a', '', 0, '', '2022-02-22', 'ira'),
('2122', 'int', 13, 0, 7771665, 'a', '', 0, '', '2022-03-01', 'int'),
('2122', 'int', 14, 0, 7771665, 'a', '', 0, '', '2022-03-08', 'int'),
('2122', 'int', 15, 0, 7771665, 'a', '', 0, '', '2022-03-15', 'int'),
('2122', 'int', 16, 0, 7771665, 'a', '', 0, '', '2022-03-22', 'int'),
...
('2122', 'ira', 7, 0, 7771665, 'a', '', 0, '', '2022-05-03', 'ira'),
('2122', 'ira', 8, 0, 7771665, 'a', '', 0, '', '2022-05-03', 'ira'),
('2122', 'ira', 9, 0, 7771665, 'a', '', 0, '', '2022-05-03', 'ira'),
