...
CREATE TABLE `mutatie` (
  `tijdstip` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'geen tijdzone conversie',
  `volgNummer` int NOT NULL,
  `knsbNummer` int NOT NULL,
  `url` varchar(100) DEFAULT NULL,
  `aantal` int DEFAULT NULL,
  `invloed` int DEFAULT NULL,
...
INSERT INTO `mutatie` VALUES ('2023-12-07 16:44:18',228,6212404,'verwijder/mutaties',387,0);
...
-- Dump completed on 2023-12-07 17:51:49
