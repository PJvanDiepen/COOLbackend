...
drop table if exists team; -- 0-0-0.nl versie 0.8.55
describe team;
...
DROP TABLE IF EXISTS speler; -- 0-0-0.nl versie 0.8.55
describe speler;
...
DROP TABLE IF EXISTS ronde; -- 0-0-0.nl versie 0.8.55
describe ronde;
...
DROP TABLE IF EXISTS uitslag; -- 0-0-0.nl versie 0.8.55
